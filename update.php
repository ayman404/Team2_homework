...
$query = "UPDATE films SET  year =$year ,rate = $rate , title = '$title' ,des ='$des',stars = '$stars', img = '$img' where title ='$title'";
...
<a href="index.php"class="button2" type="button"  data-toggle="modal2" data-target="#myModal2">Go Back</a>
    ...
    <h1 class="page_title"style="font-weight: 800;">Movie updated</h1>
